...
Repository integration tests use Testcontainers to start an isolated PostgreSQL
16 container, apply the schema migrations, and create test-specific data. Docker
must be running; the local demo seed is not loaded.
